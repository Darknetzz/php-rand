<div id="levenshtein" class="content">
    <div class="card card-primary">
        ...
        <div class="card-body">
            <p class="text-muted mb-4">Calculate the Levenshtein distance between two strings. This is the minimal number of characters you need to insert, delete, or replace to transform one string into another. The algorithm complexity is O(m×n), where m and n are the string lengths.</p>
