<div id="urlencoding" class="content">
    ...
    <div class="card card-primary">
        ...
        <div class="card-body">
            <p class="text-muted mb-4">Paste text or URL-encoded data to see the original, encoded, and decoded forms side by side.</p>
