<div id="networking" class="content">
    ...
    <!-- Subnav -->
    <nav class="module-subnav" aria-label="Network Tools navigation">
        <a class="subnav-pill" data-subtab="dns" href="#networking/dns"><?= icon("search") ?> DNS Lookup</a>
        <a class="subnav-pill" data-subtab="cidr2range" href="#networking/cidr2range"><?= icon("calculator") ?> CIDR to Range</a>
        <a class="subnav-pill" data-subtab="range2cidr" href="#networking/range2cidr"><?= icon("calculator") ?> Range to CIDR</a>
        <a class="subnav-pill" data-subtab="subnet" href="#networking/subnet"><?= icon("calculator") ?> Subnet Calculator</a>
        <a class="subnav-pill" data-subtab="iphex" href="#networking/iphex"><?= icon("arrow-left-right") ?> IP/Hex Converter</a>
    </nav>

    <!-- DNS Lookup -->
    <div class="subnav-panel" data-panel="dns">
    ...
    <!-- CIDR to Range -->
    <div class="subnav-panel" data-panel="cidr2range">
        <div class="card card-primary mb-4">
    ...
    <!-- Range to CIDR -->
    <div class="subnav-panel" data-panel="range2cidr">
        <div class="card card-primary mb-4">
    ...
    <div class="subnav-panel" data-panel="subnet">
        <div class="card card-primary mb-4">
    ...
    <!-- IP/Hex Converter -->
    <div class="subnav-panel" data-panel="iphex">
        <div class="card card-primary mb-4">
