<div id="keypair" class="content">
    ...
    <!-- Subnav -->
    <nav class="module-subnav" aria-label="Keypair tools navigation">
        <a class="subnav-pill" data-subtab="generate" href="#keypair/generate"><?= icon("key-fill") ?> Key Generator</a>
        <a class="subnav-pill" data-subtab="sign" href="#keypair/sign"><?= icon("pencil-square") ?> Sign / Verify</a>
    </nav>

    <!-- Key Generator -->
    <div class="subnav-panel" data-panel="generate">
            ...
            <div class="card-body">
                ...
                <form class="form" action="gen.php" method="POST" id="keypairForm" data-action="keypair_generate">
                    ...
                    <?= crypto_passphrase_field_html([
                        'id_prefix' => 'keypair',
                        'help' => 'When off, the private key is exported unencrypted. Passphrase protection is available in server/auto modes; client-only mode turns this off.',
                    ]) ?>
    ...
    <!-- Sign / Verify -->
    <div class="subnav-panel" data-panel="sign">
        <div class="card card-primary">
